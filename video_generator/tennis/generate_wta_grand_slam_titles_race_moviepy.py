...
DEFAULT_INPUT = PROJECT_ROOT / "data" / "processed" / "tennis" / "wta_grand_slam_titles_timeseries_1968_2026.csv"
DEFAULT_OUTPUT = PROJECT_ROOT / "data" / "processed" / "tennis" / "wta_grand_slam_titles_race_landscape_1968_2026_4min_60fps.mp4"
DEFAULT_PREVIEW = PROJECT_ROOT / "data" / "processed" / "tennis" / "wta_grand_slam_titles_race_preview.png"
...
TITLE = "WTA GRAND SLAM TITLES RACE"
SUBTITLE = "WOMEN'S SINGLES - CUMULATIVE GRAND SLAM TITLES SINCE THE OPEN ERA"
