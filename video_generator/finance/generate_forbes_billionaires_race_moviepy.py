...
DEFAULT_OUTPUT = (
    ...
    / "finance"
    / "forbes_billionaires"
    / "forbes_billionaires_race_1997_2024_3min.mp4"
)
DEFAULT_FLAGS_DIR = PROJECT_ROOT / "data" / "raw" / "flags"

TITLE = "WORLD'S BILLIONAIRES"
SUBTITLE = "TOP 12 | FORBES | 1997-2024"
LEFT_HEADER_LABEL = "NAME"
RIGHT_HEADER_LABEL = "WEALTH"
FOOTER = "BILLIONAIRES | 1997-2024"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate a landscape Forbes billionaires bar chart race.")
...
def main() -> None:
    ...
    print(f"[video_generator] Forbes billionaires race generated -> {output}")
