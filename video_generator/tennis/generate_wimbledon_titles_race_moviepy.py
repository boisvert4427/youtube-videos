...
DEFAULT_INPUT = PROJECT_ROOT / "data" / "processed" / "tennis" / "wimbledon_titles_timeseries_1968_2025.csv"
DEFAULT_OUTPUT = PROJECT_ROOT / "data" / "processed" / "tennis" / "wimbledon_titles_race_landscape_1968_2025_4min_60fps.mp4"
DEFAULT_PREVIEW = PROJECT_ROOT / "data" / "processed" / "tennis" / "wimbledon_titles_race_preview.png"
...
TITLE = "WIMBLEDON TITLES RACE"
SUBTITLE = "ATP MEN - CUMULATIVE WIMBLEDON TITLES SINCE THE OPEN ERA"
...
WIMBLEDON_COLORS = {
    ...
    "Boris Becker": "#0d6a42",
    "Rod Laver": "#d4af5b",
    "John Newcombe": "#0c5637",
    "Jimmy Connors": "#6a3b98",
    "Stefan Edberg": "#ebe3d3",
    "Stan Smith": "#f1ead8",
    "Jan Kodes": "#efe2c7",
    "Arthur Ashe": "#e1d2a6",
    "Pat Cash": "#d8c48c",
    "Roger Federer": "#5c2f84",
    "Rafael Nadal": "#0c6a42",
    "Novak Djokovic": "#efe8d8",
    "Carlos Alcaraz": "#3f8f4f",
    "Jannik Sinner": "#7a48cf",
    "Andy Murray": "#0c6a42",
    "Andre Agassi": "#eee7d5",
}
